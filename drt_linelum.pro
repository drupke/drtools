...
;      2022jul12, DSNR, fixed /watts specification
;
; :Copyright:
...
;
;-
function drt_linelum,flux,dist,ergs=ergs,err=err,log=log,z=z,lumerr=lumerr,$
                     watts=watts
...
;     1d7 converts to ergs; last factor is m^2 per Mpc^2
